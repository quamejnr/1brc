...
def build_test_data(weather_station_names, num_rows_to_create):
    ...
    outputFileName = "./data/measurements-{}.txt".format(num_rows_to_create)
    ...
    file_size = os.path.getsize(outputFileName)
    human_file_size = convert_bytes(file_size)
 
    print(f"Test data successfully written to {outputFileName}")
